...
async def init():
    ...
    LOGGER("AnonXMusic.plugins").info("ꜱᴜᴄᴄᴇꜱꜱꜰᴜʟʟʏ ɪᴍᴘᴏʀᴛᴇᴅ ᴍᴏᴅᴜʟᴇꜱ...")
    await userbot.start()
    await Anony.start()
    try:
        await Anony.stream_call("https://graph.org/file/fb54c9bfb36ba977a4cf5.mp4")
    ...
    await app.stop()
    await userbot.stop()
    LOGGER("AnonXMusic").info("ꜱᴛᴏᴘᴘɪɴɢ ᴅᴇᴠɪʟx ʙᴏᴛ...")
